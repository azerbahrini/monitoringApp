...
const activeUsersStatisticsService = require('../../../../services/statistics/activeUsersStatisticsService');
const Task = require('../../../../models/Task');

chai.use(sinonChai);

describe('activeUsersStatistics Service TEST ', () => {
  ...
  it('Expect to return an success object', async () => {
    ...
    const res = await activeUsersStatisticsService(
      startDate,
      endDate,
      customerID,
      systemID,
  ...
  it('Expect to return an success object + no filters', async () => {
    aggregateStub.returns(fixture.serviceResult);
    const res = await activeUsersStatisticsService(startDate, endDate, null, null);
    expect(aggregateStub).to.have.been.calledOnce;
    expect(res).to.be.a('object');
    expect(res).to.have.property('data');
    expect(res).to.have.property('status');
