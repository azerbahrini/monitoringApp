...
const AvgResponseTimeStatisticsService = require('../../../../services/statistics/AvgResponseTime.service');
const Task = require('../../../../models/Task');

chai.use(sinonChai);

describe('AvgResponseTimeStatistics Service TEST ', () => {
  ...
  it('Expect to return an success object', async () => {
    aggregateStub.returns(fixture.result.data);
    const res = await AvgResponseTimeStatisticsService(
      startDate,
      endDate,
      customerID,
      systemID,
  ...
  it('Expect to return an success object + no filters', async () => {
    aggregateStub.returns(fixture.result.data);
    const res = await AvgResponseTimeStatisticsService(startDate, endDate, null, null, timeZone);
    expect(aggregateStub).to.have.been.calledOnce;
    expect(res).to.be.a('object');
    expect(res).to.have.property('data');
    expect(res).to.have.property('status');
