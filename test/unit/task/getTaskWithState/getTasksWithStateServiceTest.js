...
const getTasksByUserService = require("../../../../services/task/getUserTasksWithState");
const Task = require("../../../../models/Task");
var moment = require("moment-timezone");

chai.use(sinonChai);

describe("testing get all By User grouped by type service", () => {
  let sandbox;
  let aggregateStub;
  beforeEach(() => {
  ...
  it("expect to return No Data ", async () => {
    ...
    const res = await getTasksByUserService(
      userId,      
      JSON.stringify(["Monitoring" , "Other Monitoring" ,"Other"]),
      JSON.stringify(["Done", "Pending" ,"In progress","Completed","Canceled"]),
      startDate,
      endDate,
      timeZone
    );
