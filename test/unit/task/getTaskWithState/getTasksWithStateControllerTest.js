...
describe("controller get tasks ", () => {
  ...
  beforeEach(() => {
    ...
    stubGetAll = sinon.stub(taskService, "getUserTasksWithState");
  });
  afterEach(() => {
  ...
  it("expect to send all Tasks filtred", async () => {
    ...
    await taskController.getUserTasksWithState(req, res);
  ...
  it("expect to send all Tasks filtred + route+ip", async () => {
    stubGetShift.returns({
      data: {
        role: "5fa02d8f785e4681ddfa3a6d",
        _id: "61796ddee69c9350ec22505a",
  ...
  it("expect return an error", async () => {
    stubGetShift.returns({
      data: {
        role: "5fa02d8f785e4681ddfa3a6d",
        _id: "61796ddee69c9350ec22505a",
  ...
  it("expect return an error + route + ip", async () => {
    stubGetShift.returns({
      data: {
        role: "5fa02d8f785e4681ddfa3a6d",
        _id: "61796ddee69c9350ec22505a",
