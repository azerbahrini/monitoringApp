...
const updateTaskService = require("../../../../services/task/updateTaskByUserRole.service");
...
describe("testing UPDATE Task service", () => {
  ...
  beforeEach("", () => {
    findOneAndUpdateStub = sandbox.stub(Task, "findOneAndUpdate");
  });
  ...
  it("expect to return an fail object -  Not Allowed", async () => {
    findOneAndUpdateStub.returns({
      lean: sandbox.stub().returns({
        exec: () => undefined,
      }),
