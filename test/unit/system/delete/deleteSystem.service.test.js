...
describe("testing DELETE  system service", () => {
  ...
  it("expect to return an success object", async () => {
    ...
    const res = await systemService.deleteSystemService(fixture.SystemDataTest._id);
  ...
  it("expect to return an fail object - no id", async () => {
    ...
    const res = await systemService.deleteSystemService(undefined);
    expect(res).to.be.a("object");
  ...
  it("expect to return an fail object - wrong id", async () => {
    ...
    const res = await systemService.deleteSystemService(fixture.wrongID);
