...
describe("GET system BY  ID ", () => {
  ...
  it("Sends a valid Request", async () => {
    ...
    const customerId = system.customer ;
    const typeId = system.type;
    const categoryId = system.category;
    const res = await request(app)
      .get(`/api/system/getSystemsByCustomerIdByTypeIdByCategoryId/${customerId}/type/${typeId}/category/${categoryId}`)
  ...
  it("Sends an invalid request - Wrong ID", async () => {
    it("Sends a valid Request", async () => {
      const res = await request(app)
        .get(`/api/system/getSystemsByCustomerIdByTypeIdByCategoryId/${fixture.wrongID}/type/${fixture.wrongID}/category/${fixture.wrongID}`)
        .set("content-type", "application/json");
