...
module.exports = (req, res, next) => {
    ...
    const querySchema = Joi.object().keys({
        ...
        page: Joi.number().when('paginate', {is: true, then: Joi.required(), otherwise: Joi.forbidden()}),
        size: Joi.number().when('paginate', {is: true, then: Joi.required(), otherwise: Joi.forbidden()})
    }).required();
